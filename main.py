...
class WriteToPostgres(beam.DoFn):
    ...
    def process(self, element):
        ...
        try:
            ...
            """, (
                element['transactionId'], element['productId'], element['productName'],
                element['productCategory'], element['productPrice'], element['productQuantity'],
                element['productBrand'], element['currency'], element['customerId'],
                element['transactionDate'], element['paymentMethod'], element['totalAmount']
            ))
            self.conn.commit()
